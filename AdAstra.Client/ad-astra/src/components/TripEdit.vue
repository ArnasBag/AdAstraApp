...
export default {
    ...
    methods: {
        ...mapActions('trips', ['updateTrip', 'getTrips', 'getTripById']),

        async edit() {
            this.v$.$validate()
            if (this.v$.$errors.length == 0) {
                console.log(this.trip)
                await this.updateTrip(this.trip)
    ...
    async created() {
        await this.getTrips()
        this.trip = await this.getTripById(this.$route.params.tripId)
        this.trip.startDate = this.trip.startDate.split('T')[0]
        this.trip.endDate = this.trip.endDate.split('T')[0]
    },
}
    ...
    <div class="trip-create-wrapper">
        ...
        <div class="form-wrapper">
            <div class="small-inputs">
                ...
                <FormInput v-model="trip.startDate" id="startDate" label="From" type="date"
